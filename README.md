...
Download, make executable and run with these lines :
    ...
    wget --no-check-certificate https://raw.github.com/kirrathmx/3proxy/master/3proxyinstaller.sh
...
For Uninstall Download, make executable and run with these lines :
	...
	wget --no-check-certificate https://raw.github.com/kirrathmx/3proxy/master/3proxyuninst.sh
